...
class Films extends Component {
    ...
    constructor(){
        ...
        this.state = {
            url : 'https://5f845c49c29abd001618f922.mockapi.io/api/filmes',
            nome : '',
            categoria : '',
            ano : '',
            filmes : []
...
.catch(err => console.error(err))
    ...
    render(){
        return(
            <div>
                <Menu/>
                <Jumbotron titulo='Films' descricao='Gerencie seus films' />
                ...
                <div className="container">
                    ...
                    <table className="table" style={{marginTop : '40px'}}>
                        ...
                        <tr>
                            ...
                            <th scope="col"><button type="reset" onClick={this.novoFilme.bind(this)} className="btn btn-primary" >Novo Filme</button></th>
                        </tr>
                        </thead>
